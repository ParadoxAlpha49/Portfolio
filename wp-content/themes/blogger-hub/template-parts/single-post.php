...
<article>
	<h1><?php the_title(); ?></h1>
	<?php if(get_theme_mod('blogger_hub_single_post_date',true)==1 || get_theme_mod('blogger_hub_single_post_author',true)==1 || get_theme_mod('blogger_hub_single_post_comment_no',true)==1){ ?>
		<div class="post-info py-2">
	        <?php if(get_theme_mod('blogger_hub_single_post_date',true)==1){ ?>
	            <i class="fa fa-calendar mr-1" aria-hidden="true"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><span class="entry-date mr-3"><?php echo esc_html( get_the_date() ); ?></span><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
	        <?php }?>
